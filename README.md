...
| **Standard** | 495 kr | Coachrapport ~10 sider, PDF | Volumendrivere — under impulskøb-tærskel |
| **Executive** ⭐ | 1.495 kr | + 90-dages plan, skygger ved styrker, adfærdseksperimenter | Hovedrevenue-tieren, anchored som "mest valgt" |
| **Executive + Sparring** | 4.995 kr | + 30 min Zoom med dig | Premium tier — konverterer din tid til ren toplinjeomsætning |
...
Sparring        2%            20          4.995     99.900 kr
                                                    ─────────────
                                          Total:    293.750 kr/mdr
                                          Årligt:   3.525.000 kr
```
...
**Du opretter (≈30 min):**
1. **Stripe**-konto, opret 3 Payment Links (Standard 495, Executive 1495, Sparring 4995). Aktivér automatic moms og faktura-pdf.
